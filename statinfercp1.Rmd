...
mean of `r round(samplemean,3)`. The theoretical mean is also shown as a red vertical line at 
$X=5$. It can be seen that the theoretical mean coincides with the sample mean,
at least for a sample of 1000 simulations.
